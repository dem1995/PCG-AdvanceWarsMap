...
@unique
class Tile(IntEnum):
	PLAINS				= 1,	None, TileType.TERRAIN, 'P', 'plains'
	MOUNTAIN			= 2,	None, TileType.TERRAIN, 'M', 'mountains'
	WOODS				= 3,	None, TileType.TERRAIN, 'W', 'woods'
	RIVER_EW			= 4,	None, TileType.TERRAIN, '═', 'river-ew'
	RIVER_NS			= 5,	None, TileType.TERRAIN, '║', 'river-ns'
	RIVER_C				= 6,	None, TileType.TERRAIN, '¤', 'river-nsew'
	RIVER_SE			= 7,	None, TileType.TERRAIN, '╔', 'river-se'
	RIVER_SW			= 8,	None, TileType.TERRAIN, '╗', 'river-sw'
	RIVER_NW			= 9,	None, TileType.TERRAIN, '╝', 'river-nw'
	RIVER_NE			= 10,	None, TileType.TERRAIN, '╚', 'river-ne'
	RIVER_SEW			= 11,	None, TileType.TERRAIN, '╦', 'river-sew'
	RIVER_NSW			= 12,	None, TileType.TERRAIN, '╣', 'river-nsw'
	RIVER_NEW			= 13,	None, TileType.TERRAIN, '╩', 'river-new'
	RIVER_NSE			= 14,	None, TileType.TERRAIN, '╠', 'river-nse'
	ROAD_EW				= 15,	None, TileType.TERRAIN, '━', 'road-ew'
	ROAD_NS				= 16,	None, TileType.TERRAIN, '┃', 'road-ns'
	ROAD_C 				= 17,	None, TileType.TERRAIN, '•', 'road-nsew'
	ROAD_SE				= 18,	None, TileType.TERRAIN, '┏', 'road-se'
	ROAD_SW				= 19,	None, TileType.TERRAIN, '┓', 'road-sw'
	ROAD_NW				= 20,	None, TileType.TERRAIN, '┛', 'road-nw'
	ROAD_NE				= 21,	None, TileType.TERRAIN, '┗', 'road-ne'
	ROAD_SEW			= 22,	None, TileType.TERRAIN, '┳', 'road-sew'
	ROAD_NSW			= 23,	None, TileType.TERRAIN, '┫', 'road-nsw'
	ROAD_NEW			= 24,	None, TileType.TERRAIN, '┻', 'road-new'
	ROAD_NSE			= 25,	None, TileType.TERRAIN, '┣', 'road-nse'
	BRIDGE_EW			= 26,	None, TileType.TERRAIN, '╍', 'bridge-ew'
	BRIDGE_NS			= 27,	None, TileType.TERRAIN, '╏', 'bridge-ns'
	OCEAN				= 28,	None, TileType.TERRAIN, 'O', 'ocean'
	SOUTH_FACING_BEACH	= 29,	None, TileType.TERRAIN, '🠹', 'beach-south-facing'
	NORTH_FACING_BEACH	= 30,	None, TileType.TERRAIN, '🠻', 'beach-north-facing'
	WEST_FACING_BEACH	= 31,	None, TileType.TERRAIN, '🠺', 'beach-west-facing'
	EAST_FACING_BEACH	= 32,	None, TileType.TERRAIN, '🠸', 'beach-east-facing'
	SHOAL				= 33,	None, TileType.TERRAIN, 'S', 'shoal'
	...
	PIPE_NS				= 101,	None, TileType.TERRAIN, '|', 'pipe-ns'
	PIPE_EW				= 102,	None, TileType.TERRAIN, '─', 'pipe-ew'
	PIPE_NE				= 103,	None, TileType.TERRAIN, '└', 'pipe-ne'
	PIPE_SE				= 104,	None, TileType.TERRAIN, '┌', 'pipe-se'
	PIPE_SW				= 105,	None, TileType.TERRAIN, '┐', 'pipe-sw'
	PIPE_NW				= 106,	None, TileType.TERRAIN, '┘', 'pipe-nw'
	PIPE_S				= 107,	None, TileType.TERRAIN, '╷', 'pipe-s'
	PIPE_W				= 108,	None, TileType.TERRAIN, '╴', 'pipe-w'
	PIPE_N				= 109,	None, TileType.TERRAIN,	'╵', 'pipe-n'
	PIPE_E				= 110,	None, TileType.TERRAIN, '╶', 'pipe-e'
	MISSILE_SILO		= 111,	None, TileType.TERRAIN, 'm', 'missile-silo'
	EMPTY_SILO			= 112,	None, TileType.TERRAIN, 'e', 'empty-silo'
	PIPE_SEAM_EW		= 113,	None, TileType.TERRAIN,	'╎', 'pipe-seam-ew'
	PIPE_SEAM_NS		= 114,	None, TileType.TERRAIN,	'╌', 'pipe-seam-ns'
	PIPE_SEAM_NS_RUPTURE= 115,	None, TileType.TERRAIN, 'ͷ', 'pipe-seam-ns-ruptured'
	PIPE_SEAM_EW_RUPTURE= 116,	None, TileType.TERRAIN, 'z', 'pipe-seam-ew-ruptured'
